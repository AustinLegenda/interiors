 ...
 **/
 ...
 function penta_block_editor_scripts() {
    wp_enqueue_script(
        'penta-block-editor-js',
        get_template_directory_uri() . '/scripts/penta_editor_functions.js',
        array('wp-blocks', 'wp-element', 'wp-editor'),
        filemtime(get_template_directory() . '/scripts/penta_editor_functions.js'),
        true
    );
  }
  
  add_action('enqueue_block_editor_assets', 'penta_block_editor_scripts');
